...
<!-- box-201-->
<div class="">
	<a class="box-button btn-lg btn-d btn-rd  static-top-button-lft   " style="" href="/visit-neringa.php">
		<span class="fa fa-long-arrow-left "> </span>
	</a>
</div>
<div class="">
	<a class="box-button btn-lg btn-d btn-rd    static-top-button-rgt   " style="" href="/kymsurgery.php">
...
<!-- box-38 -->
<div class="box bgc-dark-terra-cotta d-box" id="box-38">
	<div class="container box-lg">
		<div class="row">
			<!--	text for mobile		-->
			<div class="col-md-12 col-lg-5 hidden-lg ">
				<h1 class=" mg-lg sm-shadow text-left text-center    push-top-percents-5">
...
<?php
	include('row-atlikome-eshop-guliver.html');
?>
	...
	<!-- box-40 -->
<div class="box l-box bgc-white push-top-percents-5" id="box-40">
...
<!-- box-41 -->
<div class="box l-box bgc-white hidden-xs hidden-sm hidden-md" id="box-41">
	<div class="container box-lg">
		<div class="row">
...
<!-- box-41 -->
<div class="box l-box bgc-white hidden-lg" id="box-41-mobile">
	<div class="container box-lg">
		<div class="row">
...
<!-- box-42 -->
<div class="box bgc-dark-terra-cotta d-box" id="box-42">
...
<!-- box Group -->
<div class='box-group push-percents-10'>

	<!-- box-44 -->
	<div class="box l-box bgc-white box-tile-2" id="box-44">
		<div class="container box-lg">
			<div class="row">
				<div class="col-sm-12 ">
	...
	<!-- box-44 END -->
	<!-- box-45 -->
	<div class="box l-box bgc-white box-tile-2 " id="box-45">
		<div class="container box-lg">
			<div class="row">
...
<!-- box-50 -->
<div class="box l-box bgc-white push-bottom-percents-15" id="box-50">
	<div class="container box-lg">
		<div class="row">
			<div class="col-sm-12">
...
<!-- box-51 -->
<div class="box bgc-white b-parallax bg-city-overlay d-box" id="box-51">
	<div class="container box-xxl">
		<div class="row">
			<div class="col-sm-12">
